...
pygame.mixer.music.load(r"C:\Users\jramo\OneDrive\Desktop\PYTHON GAMES\scripts\ALICE.mp3")  # Replace with your music file path
        ...
        for event in pygame.event.get():
            ...
            if event.type == pygame.MOUSEBUTTONDOWN:
                if start_button.collidepoint(event.pos):
                    ...
                    return show_game_mode_screen(window)
# Load the background image
BACKGROUND_IMAGE = pygame.image.load("2048.jpg")
